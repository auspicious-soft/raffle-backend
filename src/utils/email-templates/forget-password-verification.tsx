...
const ForgotPasswordVerification: React.FC<Readonly<EmailProps>> = ({ otp }) => {
  const subject = "Reset Your Password";
  const body = "Use the OTP below to reset your password:";
  const footer =
    "If you didn't request a password reset, you can safely ignore this email.";
  const expiry = "This OTP will expire in 2 minutes.";
